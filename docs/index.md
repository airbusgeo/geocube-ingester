...
It currently supports Sentinel-1, Sentinel-2, Landsat8-9, Pléiades and SPOT and it's designed to easily add new sources of data or satellites using the [interfaces](developer-guide/interfaces.md).
