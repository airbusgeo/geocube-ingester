...
- an image provider, to download the products returned by the catalogue service (currently supported : PEPS, Creodias, GCS, local provider for Sentinel 1 and 2 with an appropriate user account)
