module github.com/airbusgeo/geocube-ingester
...
require (
	...
	github.com/airbusgeo/geocube v1.0.3-0.20240920083830-696ee806c555
	github.com/airbusgeo/geocube-client-go v1.0.1
